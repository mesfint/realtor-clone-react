             ...
             placeholder='Email address'
              ...
              <div className='flex justify-between whitespace-nowrap  text-sm sm:text-lg'>
                <p className="mb-6">Don't have account?
                  <Link to="/sign-up" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out mx-1' >Register</Link>
                </p>
                <p>
                  <Link className='text-blue-600 hover:text-blue-800 transition duration-200 ease-in-out mx-1'to="/sign-in">Sign in instead</Link>
                </p>
              </div>
          </form>
